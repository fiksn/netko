...
{
    // Convert netko:// to netko:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("netko://"))
    {
        uri.replace(0, 12, "netko:");
    }
...
{
    return GetAutostartDir() / "netko.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Netko-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  netko-qt [" + tr("command-line options") + "]                     " + "\n";
